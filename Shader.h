...
class Shader{
    ...
    bool set_int(const char* vari_name,const int &i);
    unsigned int Shader::set_texture(const char *path, const char *sampler_name,unsigned int gl_texture_type=0x0DE1);//default texture type is GL_TEXTURE_2D
private:
